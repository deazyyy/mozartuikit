...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null, isAbsoluteUrl ? (React__default['default'].createElement(StyledLink, { as: "a", href: href, "aria-label": "Pancake home page" },
        React__default['default'].createElement("img", { src: "images/mozart/logo.png", alt: "piano", className: "logoimg" }))) : (React__default['default'].createElement(StyledLink, { to: href, "aria-label": "Pancake home page" },
        React__default['default'].createElement("img", { src: "images/mozart/logo.png", alt: "piano", className: "logoimg" })))));
};
...
var Menu = function (_a) {
    ...
    return (React__default['default'].createElement(Wrapper, null,
        ...
        React__default['default'].createElement(BodyWrapper, null,
            ...
            React__default['default'].createElement(Inner, { isPushed: isPushed, showMenu: showMenu, className: "innerbody" }, children),
